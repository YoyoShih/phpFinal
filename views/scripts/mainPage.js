...
(async function getMusic() {
    fetch('http://localhost/final/phpFinal/models/getUserMusic.php', {
        method: "GET",
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
        ...
        response.json().then(result => {
            var musics = result
            // var musics = [
            //     { songName: 'LILAC', produce: 'IU', genre: '放克' },
            //     { songName: '爸爸媽媽', produce: '李榮浩', genre: '流行' }
            // ]
            var music = ''
            while (music = musics.shift()) {
